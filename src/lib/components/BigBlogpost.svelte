...
<div class="{$visitedBlog ? "" : "animate-comeup "}h-fit flex flex-col gap-4 cursor-pointer" on:click={() => {openBlogpost(id)}}>
    <!-- 8:3 ratio -->
    <img src="{blogpost.thumbnail}" alt="thumbnail" class="w-full h-[24rem] object-cover rendering-crisp-edges rounded-3xl shadow-[#00000077] shadow-2xl">
    <span class="flex">
